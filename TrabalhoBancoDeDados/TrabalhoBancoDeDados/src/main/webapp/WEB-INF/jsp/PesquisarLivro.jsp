...
<body>
	<form name="form1" method="get" action="/pesquisarLivro">
		<table>
			...
			<tr>
				<td><font color="black" size="14"><%= request.getSession().getAttribute("livroPesquisado")!=null ?request.getSession().getAttribute("livroPesquisado"):"Não achado"  %></font>
			</tr>
			<tr>
